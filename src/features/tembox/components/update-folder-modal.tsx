...
export const UpdateFolderModal = () => {
    const { isOpen, setIsOpen, close, folderId, folderName: initialFolderName, folderColor: initialFolderColor } = useUpdateFolderModal();
    ...
    useEffect(() => {
        if (isOpen && initialFolderName && initialFolderColor) {
            setFolderName(initialFolderName);
            setSelectedColor(initialFolderColor);
        }
